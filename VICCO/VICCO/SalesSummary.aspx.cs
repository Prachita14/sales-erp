...
namespace VICCO
{
    public partial class SalesSummary : System.Web.UI.Page
    {
        ...
        public void BindMaterialName()
        {
            ...
            objMaterial.GROUP_NAME = auto_select7.SelectedItem.Value;
            DataTable dtMaterial = new DataTable();
            dtMaterial = objMaterial.SaveMaterial();

            auto_select6.DataSource = dtMaterial;
            auto_select6.DataValueField = "MATERIAL_ID";
            auto_select6.DataTextField = "MATERIAL_DESCREPTION";
            auto_select6.DataBind();
            auto_select6.Items.Insert(0, new ListItem("Material Name", "0"));
        }
        ...
        public void BindMaterialGroup()
        {
            ...
            auto_select7.DataSource = dtMaterial;
            auto_select7.DataValueField = "MATERIAL_GROUP";
            auto_select7.DataTextField = "MATERIAL_GROUP";
            auto_select7.DataBind();
            auto_select7.Items.Insert(0, new ListItem("Material Group", "0"));
        }
        ...
        public void BindStockistName()
        {
            ...
            auto_select1.Items.Insert(0, new ListItem("All Stockist", "0"));
        }
        ...
        public void GetReport()
        {
            ...
            if (auto_select7.SelectedItem.Value != "0")
            {
                objReport.Material_Group = auto_select7.SelectedItem.Value;
            }

            if (auto_select6.SelectedIndex != -1)
            {
            ...
            if (ddlType.SelectedItem.Text == "All India")
            {
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SalesSummry.rdlc");
            }
            else if (ddlType.SelectedItem.Text == "Stockist Wise")
            {
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SaleSummaryStockist.rdlc");
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SalesSummaryState.rdlc");
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ddlRegion.Items.Insert(0, new ListItem("All Region", "0"));
                auto_select1.Items.Insert(0, new ListItem("Select", "0"));
                auto_select2.Items.Insert(0, new ListItem("Select", "0"));
                auto_select3.Items.Insert(0, new ListItem("Select", "0"));
                auto_select4.Items.Insert(0, new ListItem("Select", "0"));
                auto_select5.Items.Insert(0, new ListItem("Select", "0"));
        ...
        protected void ddlTypeTextChange(object sender, EventArgs e)
        {
            if (ddlType.SelectedItem.Text == "All India")
            {
                ddlRegion.Items.Clear();
                auto_select1.Items.Clear();
                auto_select2.Items.Clear();
                auto_select3.Items.Clear();
                auto_select4.Items.Clear();
                auto_select5.Items.Clear();
