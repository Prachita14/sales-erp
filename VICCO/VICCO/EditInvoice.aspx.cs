...
namespace VICCO
{
    public partial class EditInvoice : System.Web.UI.Page
    {
        ...
        //    try
        //    {
        //        Purches_Order_Management objProduct = new Purches_Order_Management();
        //        objProduct.stockist_id = Convert.ToInt32(Request.QueryString["sid"]);
        //        objProduct.Purchaseorder_Id = Convert.ToInt32(lblPurchaseOederid.Text);
        //        objProduct.Po_No = txtPoNo.Text;
        //        objProduct.Date = Convert.ToDateTime(txtCalender.Text);
        //        objProduct.Delivery_Period = txtDelieveryPeriod.Text;
        //        objProduct.Note = txtNote.Text;
        //        objProduct.Payment_Terms = txtVehicle.Text;
        //        objProduct.transport = txtNoOfCases.Text;
        //        objProduct.Gst_no = txtSalesOffer.Text;
        //        objProduct.Sp_Operation = "UPDATE";
        //        objProduct.SaveUser();
        //    }
        //    catch (Exception ex)
        //    {
        ...
        public void InsertToPurchaseOrder(string is_print)
        {
            ...
            //objUser.MODIFIED_BY = Convert.ToInt32(Request.Cookies["UserID"].Value);
        ...
        public void GetPoDetailsByPo_no()
        {
            try
            {
                ...
                lblStockistid.Text = Convert.ToString(dtUser.Rows[0]["STOCKIST_ID"]);
                if (dtUser.Rows.Count > 0)
                {
        ...
        public void ManageInvoiceAndStock()
        {
            try
            {
                ...
                objDeletePurchase.stockist_id = Convert.ToInt32(lblStockistid.Text);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (Request.QueryString["type"] == "igst")
            //{
            //    string type = Convert.ToString(Request.QueryString["type"]); ;
            //    int sid = Convert.ToInt32(Request.QueryString["sid"]);
            //    int invoiceno = Convert.ToInt32(Request.QueryString["invoiceno"]);
            //    Response.Redirect("~/EditIgstInvoice.aspx?type=" + type + "&sid=" + sid + "&invoiceno=" + invoiceno + "");
            //}
            //else
            //{
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (CheckPono() != true)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, GetType(), "newpage", "customOpen('POFormPrint.aspx?type=gst&invoiceno=" + lblPurchaseOederid.Text + "');", true);
            }
            else
            {
