<%@ Page Title="" Language="C#" MasterPageFile="~/Stockist.Master" AutoEventWireup="true"
    CodeBehind="InitialGoodReceipt.aspx.cs" Inherits="VICCO.InitialGoodReceipt" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="InitialGoodReceipt.aspx">Manage Good Receipt</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-Width="60px">
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <a href='AdminInitialDispatch.aspx?invno=<%# Eval("INVOICE_NO")%>' class="btn btn-info"
                                                                style="padding: 5px; font-size: 11px; width: 60px; color: White; margin-right:10px;">View </a>
                                                        </td>
                                                        <td>
                                                           
                                                             <asp:HyperLink ID="btnupdate" NavigateUrl='<%# "UpdateGoodReceipt.aspx?invno=" + Eval("INVOICE_NO")%>' CssClass="btn btn-warning"
