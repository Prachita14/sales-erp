<%@ Page Title="" Language="C#" MasterPageFile="~/Stockist.Master" AutoEventWireup="true" CodeBehind="UpdateInitialGoodReceipt.aspx.cs" Inherits="VICCO.UpdateInitialGoodReceipt" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="UpdateInitialGoodReceipt.aspx">Update Received Material</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
