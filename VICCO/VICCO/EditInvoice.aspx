<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditInvoice.aspx.cs" Inherits="VICCO.EditInvoice" %>
                                                    ...
                                                    <asp:TemplateField HeaderText="QTY. IN PCS" HeaderStyle-Width="7%">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Invalid Input"
                                                                ...
                                                                ForeColor="Red" Display="Dynamic" ValidationGroup="check"></asp:RegularExpressionValidator>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="DIS. IN %" HeaderStyle-Width="9%">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Invalid Disc."
                                                                ...
                                                                MinimumValue="0.00" MaximumValue="99.00" ValidationGroup="check"></asp:RangeValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
