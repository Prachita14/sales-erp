    ...
    public partial class TargetReport : System.Web.UI.Page
    {
        ...
        public void GetTargetReport()
        {
            try
            {
                ...
                {
                    objReport.from_date = Convert.ToDateTime("1 " + auto_select7.SelectedItem.Text + " " + auto_select6.SelectedItem.Text);
                }
                ...
                dtrow["REGION"] = ddlRegion.SelectedItem.Text;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                auto_select7.SelectedItem.Text = System.DateTime.Now.ToString("MMM");
                auto_select7.SelectedItem.Value = System.DateTime.Now.ToString("MM");

                auto_select6.SelectedItem.Text = System.DateTime.Now.ToString("yyyy");
                auto_select5.Items.Insert(0, new ListItem("Town Name", "0"));
                auto_select3.Items.Insert(0, new ListItem("District Name", "0"));
                auto_select2.Items.Insert(0, new ListItem("Super Stockist", "0"));
                auto_select4.Items.Insert(0, new ListItem("Distributor Name", "0"));
            }
        }
