<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="AdminDispatched.aspx.cs" Inherits="VICCO.AdminDispatched" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="AdminDispatched.aspx">Dispatched Report</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div style="width: 100%; overflow: auto;">
                                    <asp:GridView ID="grdDistributor" runat="server" Width="1500px" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Billed Qty. In Cases">
                                                <ItemTemplate>
