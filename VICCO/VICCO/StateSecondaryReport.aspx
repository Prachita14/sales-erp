<%@ Page Title="" Language="C#" MasterPageFile="~/office.Master" AutoEventWireup="true"
    CodeBehind="StateSecondaryReport.aspx.cs" Inherits="VICCO.StateSecondaryReport" %>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                State Wise Secondary Report</h4>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-3">
                                <asp:DropDownList ID="auto_select1" runat="server" class="form-control" data-placeholder="Material Name">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" InitialValue="Material Group" ErrorMessage="Material Required..."
                                        ControlToValidate="auto_select1" Display="Dynamic" CssClass="error" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                           ...
                           <%-- <div class="col-md-2">
                                    ...
                                    <asp:ListItem>Select From Year</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="Select From Year" ErrorMessage="Year Required..."
                                        ControlToValidate="auto_select4" Display="Dynamic" CssClass="error" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>--%>

                                <div class="col-md-2">
                                    <asp:DropDownList ID="auto_select5" runat="server" class="form-control" data-placeholder="Month">
                                    <asp:ListItem>Select To Month</asp:ListItem>
                                    <asp:ListItem>Jan</asp:ListItem>
                                    <asp:ListItem>Feb</asp:ListItem>
                                    <asp:ListItem>Mar</asp:ListItem>
                                    <asp:ListItem>Apr</asp:ListItem>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" InitialValue="Select To Month" ErrorMessage="Month Required..."
                                        ControlToValidate="auto_select5" Display="Dynamic" CssClass="error" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            <div class="col-md-2">
