<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="PartyWiseSaleReportQuantity.aspx.cs" Inherits="VICCO.PartyWiseSaleReportQuantity" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="PartyWiseSaleReportQuantity.aspx">Party Wise Sale Report Quantity</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">Party Wise Sale Report Quantity</h4>
                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="col-md-3" runat="server" id="region_ddl">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="panel panel-danger">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">Inactive Party Report</h4>
                                                    </div>
                                                    <div id="errorMsg1" runat="server" visible="false" class="alert alert-warning" style="background-color: #f5f5f5; color: #505b72;">
                                                        <strong>Oops! No record found..</strong>
                                                    </div>
                                                    <div class="panel-body">
                                                        <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%" AsyncRendering="true"
                                                            PageCountMode="Actual" Style="overflow: auto;" SizeToReportContent="true">
                                                        </rsweb:ReportViewer>
                                                    </div>
                                                </div>
