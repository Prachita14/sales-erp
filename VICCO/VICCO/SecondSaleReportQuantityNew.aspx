<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SecondSaleReportQuantityNew.aspx.cs" Inherits="VICCO.SecondSaleReportQuantityNew" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="SecondSaleReportQuantity.aspx">Product Wise Second Sale Report Quantity</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                Product Wise Second Sale Report Quantity</h4>
                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="col-md-12">
                                                    <%-- <asp:DropDownList ID="auto_select4" runat="server" class="form-control" data-placeholder="Distributor Name" AutoPostBack="true" OnSelectedIndexChanged="ddlDistributor_Change">
                                                      </asp:DropDownList>--%>
