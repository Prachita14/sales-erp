...
namespace VICCO
{
    public partial class SecondSaleReportValueNew : System.Web.UI.Page
    {
        ...
        public void GetSeconSaleReport()
        {
            try
            {
                ...
                objReport.SpOperation = "SECOND_SALE_REPORT_VALUE";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SecondSaleValue.rdlc");
