...
namespace VICCO
{
    public partial class StateSecondaryReport : System.Web.UI.Page
    {
        ...
        public void BindMaterialName()
        {
            ...
            auto_select1.Items.Insert(0, new ListItem("Material Group", "0"));
        }
        ...
        public void GetSaleStockReport()
        {
            try
            {
                ...
                objReport.from_date = Convert.ToDateTime("1 " + auto_select3.SelectedItem.Text + " " +(Convert.ToInt32(auto_select6.SelectedItem.Text)-1).ToString());
                objReport.To_date = Convert.ToDateTime("1 " + auto_select5.SelectedItem.Text + " " + auto_select6.SelectedItem.Text);

                objReport.SpOperation = "STATE_SECONDARY";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/StateSecondaryReport.rdlc");
