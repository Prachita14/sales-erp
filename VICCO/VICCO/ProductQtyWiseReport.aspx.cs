...
namespace VICCO
{
    public partial class ProductQtyWiseReport : System.Web.UI.Page
    {
        ...
        public void ProductAndValueWiseReport()
        {
            try
            {
                ...
                objReport.SpOperation = "PRODUCT_QTY_WISE_SECONDARY_REPORT";
                ...
                ReportParameter para1 = new ReportParameter("TITLE","PRODUCT AND QTY WISE SECONDARY REPORT "+ "(" + ddlRegion.SelectedItem.Text +")");
