<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DispatchInitialToStockist.aspx.cs" Inherits="VICCO.DispatchInitialToStockist" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="DispatchInitialToStockist.aspx">Dispatch Initial Report</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 row" style="margin-bottom: 30px;">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="auto_select1" runat="server" class="select form-control" data-placeholder="Super Stockist Name">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlStatus" runat="server" class="select form-control">
                                ...
                                <asp:GridView ID="grdReport" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left">
                                            <ItemTemplate>
                                                <a href='AdminInitialDispatch.aspx?invno=<%# Eval("INVOICE_NO")%>' class="btn btn-info"  style="padding: 5px; Font-Size:11px; Width:60px; color:White; height:25px;">View
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
