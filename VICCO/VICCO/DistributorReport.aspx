<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DistributorReport.aspx.cs" Inherits="VICCO.DistributorReport" %>
                            ...
                            <div class="col-md-12 row" style="margin-bottom: 30px;">
                                ...
                                <div class="col-md-1">
                                    <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary"
                                        OnClick="btnSearch_Distributor" Width="80px"/>
                                </div>
                                <div class="col-md-2">
                                    <a href="DistributorReportDetails.aspx" target="_blank" class="btn btn-info">Show All Details</a>
                                </div>
                            </div>
                            <div class="clearfix">
                            </div>
                            <div class="table-responsive">
                                <div id="errorMsg" visible="false" runat="server" class="alert alert-warning" style="background-color: #d8dce3;
                                    color: #505b72;">
                                ...
                                <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Type">
                                            <ItemTemplate>
                                                <asp:Label ID="Label22" runat="server" Font-Bold="false" Text='<%# Eval("DISTRIBUTOR_TYPE")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                        
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Region">
                                            <ItemTemplate>
                                                <asp:Label ID="Label4" runat="server" Font-Bold="false" Text='<%# Eval("REGION")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                        
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Email">
                                         ...
                                         <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Status">
                                            <ItemTemplate>
                                                <asp:Label ID="Label8" runat="server" Font-Bold="false" Text='<%# Eval("STATUS")%>'></asp:Label>
                                                <asp:Label ID="Label81" runat="server" Font-Bold="false" Font-Size="10px" Text='<%# Eval("DEACTIVE_DATE", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="70px">
                                            <ItemTemplate>
                                                <a href='Distributor.aspx?did=<%# Eval("DISTRIBUTOR_ID")%>'><i class="fa fa-pencil"></i>
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <div class="modal-content" style="height: 550px; overflow: auto;">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        <asp:Label ID="lblStockistName" runat="server" Text="Name" CssClass="modellabel"></asp:Label></p>
                    <p>
                        <span>Address : </span>
                    ...
                    <p>
                        <span>State : </span>
                        <asp:Label ID="lblState" runat="server" CssClass="modellabel"></asp:Label></p>
                    <p>
                   ...
                   <p>
                        ...
                        <asp:Label ID="lbltype" runat="server" CssClass="modellabel"></asp:Label></p>
