    ...
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        public void GetSiteDetailsAndNo()
        {
            ...
            if (dtpo.Rows.Count > 0)
            {
                ...
                //txtInitalWord.Text = Convert.ToString(dtpo.Rows[0]["INTITAL_PONO"]);

                //if (Convert.ToString(dtpo.Rows[0]["NUMERIC_PONO"]) != "")
                //{
                //    txtNo.Enabled = false;
                //}
                //txtNo.Text = Convert.ToString(dtpo.Rows[0]["NUMERIC_PONO"]);
                //Span_invno.InnerText = txtInitalWord.Text + txtNo.Text;
            }
        }
        ...
        public void InsertToPurchaseOrder(string is_print)
        {
            ...
            objUser.Po_No = txtPoNo.Text;
            //txtInitalWord.Text + txtNo.Text;
            //objUser.INTITAL_PONO = txtInitalWord.Text;

            //if (txtNo.Text != "")
            //{
            //    objUser.NUMERIC_PONO = Convert.ToInt32(txtNo.Text);
            //}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string s = localTime.ToString("dd MMM yyyy");
                txtCalender.Text = s;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckPono() != true)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, GetType(), "newpage", "customOpen('POFormPrint.aspx?email=yes&type=igst&invoiceno=" + lblPurchaseOederid.Text + "');", true);
                }
                else
                {
            ...
            {
                ExceptionLog.WriteErrorLog(ex);
                Response.Redirect("~/Invoiceigst.aspx");
            }
        }
