...
namespace VICCO
{
    public partial class SecondSaleReportQuantity : System.Web.UI.Page
    {
        ...
        public void GetSeconSaleReport()
        {
            try
            {
                ...
                objReport.SpOperation = "SECOND_SALE_REPORT_QUANTITY";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SecondSaleValueQuantity.rdlc");
