<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoiceigst.aspx.cs" Inherits="VICCO.Invoice" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
      ...
      <%--  function getNextButton(btnid) {
        ...
        function SuccessOk() {
            alertify.alert('Success', 'Invoice Save Successfully...!', function () { alertify.success(window.location = "Invoiceigst.aspx"); });
        }
    ...
    <script type="text/javascript">
        function customOpen(url) {
            alertify.alert('Success', 'Invoice Save Successfully...!', function () { window.open(url, '_blank'); window.location = "Invoiceigst.aspx" });
        }
    </script>
</head>
<body>
