...
namespace VICCO
{
    public partial class ProductStateWiseSecondaryReport : System.Web.UI.Page
    {
        ...
        public void ProductAndStateWiseReport()
        {
            try
            {
                ...
                objReport.SpOperation = "PRODUCT_STATE_WISE_QUANTITY_SECONDARY_REPORT";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ProductAndStateWiseReport.rdlc");
                ReportViewer1.LocalReport.DataSources.Clear();

                ReportParameter para1 = new ReportParameter("TITLE", "PRODUCT & STATE-WISE SECONDARY REPORT (QTY) " + auto_select1.SelectedItem.Text);
