...
namespace VICCO
{
    public partial class SaleStockReport : System.Web.UI.Page
    {
        #region "Public Function"

        decimal total_opening = 0, total_inword = 0, total_closing = 0, total_second_sale = 0, total_return = 0, total_value = 0;
