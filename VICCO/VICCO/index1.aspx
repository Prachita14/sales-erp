<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index1.aspx.cs" Inherits="VICCO.index1" %>
    ...
    <div class="panel signin">
        ...
        <div class="panel-body">
            <div id="email">
                <div class="form-group mb10">
                    <div class="input-group">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" class="form-control" autocomplete="off"
            ...
            <div>
                ...
                <br />
                <div class="form-group">
                    <asp:Button ID="btnLogin" runat="server" Text="Sign In" CssClass="btn btn-success btn-quirk btn-block"
                        OnClick="btnLogin_Click" OnClientClick="Loginclick()" ValidationGroup="login" />
                </div>
            </div>
        </div>
    </div>
