<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="SaleStockReport.aspx.cs" Inherits="VICCO.SaleStockReport" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="SaleStockReport.aspx">Stock And Sale Report</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                         ...
                         <div class="col-md-1">
                                        <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary" autofocus
