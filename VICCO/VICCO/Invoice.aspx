<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="VICCO.Invoice1"  %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SuccessOk() {
            alertify.alert('Success', 'Invoice Save Successfully...!', function () { alertify.success(window.location = "Invoice.aspx"); });
        }
    ...
    <script type="text/javascript">
        function customOpen(url) {
            alertify.alert('Success', 'Invoice Save Successfully...!', function () { window.open(url, '_blank'); window.location = "Invoice.aspx" });
        }
    </script>
</head>
<body>
                                               ...
                                               DataKeyNames="PURCHES_ORDER_PRODUCT_ID" BorderStyle="None" OnRowDataBound="grdProduct_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="HSN CODE" HeaderStyle-Width="8%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtHsnCode" runat="server" Text='<%# Eval("UNIT")%>' CssClass="form-control"
                                                    ...
                                                    <asp:TemplateField HeaderText="QTY. IN PCS" HeaderStyle-Width="7%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtQty" runat="server" Text='<%# Eval("QTY")%>' CssClass="form-control" CausesValidation="true" ValidationGroup="check"
                                                                AutoPostBack="true" OnTextChanged="ProductContent_TextChange"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Invalid Input" ValidationGroup="check"
                                                    ...
                                                    <asp:TemplateField HeaderText="RATE" HeaderStyle-Width="9%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate" runat="server" Text='<%# Eval("RATE")%>' CssClass="form-control" CausesValidation="true" ValidationGroup="check"
                                                                AutoPostBack="true" OnTextChanged="ProductContent_TextChange" ></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="Invalid Input" ValidationGroup="check"
                                                    ...
                                                    <asp:TemplateField HeaderText="SCHEME IN %" HeaderStyle-Width="9%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtScheme" runat="server" Text='<%# Eval("SCHEME")%>' CssClass="form-control" CausesValidation="true" ValidationGroup="check"
                                                                AutoPostBack="true" OnTextChanged="ProductContent_TextChange"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Invalid Input" ValidationGroup="check"
                                                    ...
                                                    <asp:TemplateField HeaderText="DIS. IN %" HeaderStyle-Width="9%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtDiscount" runat="server" Text='<%# Eval("DISCOUNT")%>' CssClass="form-control" CausesValidation="true" ValidationGroup="check"
                                                                AutoPostBack="true" OnTextChanged="ProductContent_TextChange" ></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ErrorMessage="Invalid Input" ValidationGroup="check"
                                                                SetFocusOnError="true" ControlToValidate="txtDiscount" ValidationExpression="^[0-9][\.\d]*(,\d+)?$"
                                                                ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                                                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Invalid Input"
                                                    ...
                                                    <asp:TemplateField HeaderText="CGST" HeaderStyle-Width="6%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtCGST" runat="server" Text='<%# Eval("CGST")%>' CssClass="form-control"
                                                                ReadOnly="true"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="SGST" HeaderStyle-Width="6%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtSGST" runat="server" Text='<%# Eval("SGST")%>' CssClass="form-control"
                                                                ReadOnly="true"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div id="Div3" class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <%--<asp:TextBox ID="txtSalesOffer" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>--%>
