<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="SaleStockDistributor.aspx.cs" Inherits="VICCO.SaleStockDistributor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MaterialChange() {
            ...
            var e = document.getElementById("ContentPlaceHolder1_auto_select3");
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="SaleStockDistributor.aspx">Sale Stock Distributor</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                               Sale Stock Distributor Report</h4>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="auto_select3" runat="server" class="form-control" data-placeholder="Material Name"
