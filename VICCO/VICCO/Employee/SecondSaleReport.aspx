<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.Master" AutoEventWireup="true"
    CodeBehind="SecondSaleReport.aspx.cs" Inherits="VICCO.SecondSaleReport" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="table-responsive">
                                           ...
                                           <%-- <asp:GridView ID="grdSecondSaleReport" runat="server" Width="100%" AutoGenerateColumns="False"
                                                OnPageIndexChanging="grdSecondSaleReport_PageIndexChanging" AllowPaging="true"
