...
{
    public partial class EmpHeadReport : System.Web.UI.Page
    {
        ...
        public void GetTargetReport()
        {
            try
            {
                ...
                //reportParameter[0] = new ReportParameter("From_Date", txtFromDate.Text);
                //reportParameter[1] = new ReportParameter("To_Date", txttoDate.Text);
        ...
        public void BindRegion()
        {
            try
            {
                ...
                auto_select2.DataSource = objRegion.GetReport();
