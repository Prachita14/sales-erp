...
namespace VICCO
{
    public partial class PartyWiseSaleReportValue : System.Web.UI.Page
    {
        ...
        public void BindDropDown()
        {
            try
            {
                ...
                if (auto_select3.SelectedItem.Text != "District Name")
                {
                    objTown.District = auto_select3.SelectedItem.Text;
                }
        ...
        public void GetSeconSaleReport()
        {
            try
            {
                ...
                objReport.SpOperation = "PARTY_WISE_SALE_REPORT_VALUE";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/PartyWiseValue.rdlc");
