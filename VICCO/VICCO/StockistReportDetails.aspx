<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockistReportDetails.aspx.cs" Inherits="VICCO.StockistReportDetails" %>
                                ...
                                <asp:GridView ID="grdReport" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Stockist Code">
                                            <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Font-Bold="false" Text='<%# Eval("CODE")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Super Stockist Name">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Region">
                                            <ItemTemplate>
                                                <asp:Label ID="Label7" runat="server" Font-Bold="false" Text='<%# Eval("STOCKIST_REGION")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Assign Region">
                                            <ItemTemplate>
                                                <asp:Label ID="Label7" runat="server" Font-Bold="false" Text='<%# Eval("ASSIGN_REGION")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
