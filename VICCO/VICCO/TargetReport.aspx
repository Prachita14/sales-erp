<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="TargetReport.aspx.cs" Inherits="VICCO.TargetReport" %>
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 row" style="margin-bottom: 30px;">
                               ...
                               <div class="col-md-2">
                                    <asp:DropDownList ID="auto_select7" runat="server" class="form-control" data-placeholder="Month">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="0"
                                        ErrorMessage="Month Required..." ControlToValidate="auto_select7" Display="Dynamic"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="Extra-pagination" style="float: right; padding-top:20px;">
                                        ...
                                        <asp:Button ID="btnPrivious" runat="server" Text="Privious" CssClass="btn btn-default"
                                            OnClientClick="addLoadingimg()" OnClick="btnPriviousClick" Visible="false" Width="100px" />
                                        <asp:Button ID="btnNext" runat="server" Text="Next" CssClass="btn btn-default" OnClientClick="addLoadingimg()"
                                            OnClick="btnNextClick" Width="100px" Visible="false" />
                                    </div>
                                </div>
