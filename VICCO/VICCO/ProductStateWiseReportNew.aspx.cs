...
namespace VICCO
{
    public partial class ProductStateWiseReportNew : System.Web.UI.Page
    {
        ...
        public void ProductAndStateWiseReport()
        {
            try
            {
                ...
                objReport.SpOperation = "PRODUCT_STATE_WISE_SECONDARY_REPORT_NEW";
                ...
                title["Title"] = "PRODUCT & STATE-WISE SECONDARY REPORT (VALUE) " + auto_select1.SelectedItem.Text;
                dt.Rows.Add(title);
