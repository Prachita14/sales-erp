...
namespace VICCO.DAL
{
    public class Report_management
    {
        ...
        public void AddwithParameter(SqlCommand Command)
        {
            ...
            if (Emp_ids != string.Empty && Emp_ids != null)
                Command.Parameters.Add(new SqlParameter("@EMP_IDS", SqlDbType.VarChar)).Value = Emp_ids;
            else
                Command.Parameters.Add(new SqlParameter("@EMP_IDS", SqlDbType.VarChar)).Value = DBNull.Value;
            ...
            if (Distributor_ids != string.Empty && Distributor_ids != null)
                Command.Parameters.Add(new SqlParameter("@DISTRIBUTOR_IDS", SqlDbType.VarChar)).Value = Distributor_ids;
            else
                Command.Parameters.Add(new SqlParameter("@DISTRIBUTOR_IDS", SqlDbType.VarChar)).Value = DBNull.Value;
        ...
        public DataTable GetReport()
        {
            ...
            {
                cmd = new SqlCommand("REPORT_MANAGEMENT", con);
