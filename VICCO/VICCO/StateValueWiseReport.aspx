...
CodeBehind="StateValueWiseReport.aspx.cs" Inherits="VICCO.StateValueWiseReport" %>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            <ol class="breadcrumb breadcrumb-quirk">
                ...
                <li><a href="SecondaryCumulativeReport.aspx">State and Value Wise Secondary Report</a></li>
            </ol>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                State and Value Wise Secondary Report</h4>
                        </div>
                            ...
                            <div class="col-md-3">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" AsyncRendering="true"
                                            PageCountMode="Actual" Style="width: 100%;" SizeToReportContent="true">
                                        </rsweb:ReportViewer>
                                    </div>
                                    <!-- table-responsive -->
