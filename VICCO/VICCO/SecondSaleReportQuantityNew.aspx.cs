...
namespace VICCO
{
    public partial class SecondSaleReportQuantityNew : System.Web.UI.Page
    {
        ...
        public void BindDistrict()
        {
            try
            {
                ...
                for (int i = 0; i <= select2.Items.Count - 1; i++)
                {
                    if (select2.Items[i].Selected)
                    {
                        objDistrict.Distributor_ids += select2.Items[i].Text + ",";
                    }
                }
        ...
        public void GetSeconSaleReport()
        {
            try
            {
                ...
                objReport.SpOperation = "SECOND_SALE_REPORT_QUANTITY_NEW";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SecondSaleValueQuantityNew.rdlc");
