...
namespace VICCO
{
    public partial class BilledReport : System.Web.UI.Page
    {
        #region "Public Function"

        public void GetBilledReport()
        {
            try
            {
                ...
                objReport.SpOperation = "BILLED_REPORT";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/BilledReport.rdlc");
