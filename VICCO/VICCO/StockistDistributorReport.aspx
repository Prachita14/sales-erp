<%@ Page Title="" Language="C#" MasterPageFile="~/Stockist.Master" AutoEventWireup="true" CodeBehind="StockistDistributorReport.aspx.cs" Inherits="VICCO.StockistDistributorReport" %>
                                ...
                                <div id="errorMsg" runat="server" class="alert alert-warning" style="background-color: #d8dce3;
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Address">
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Font-Bold="false" Text='<%# Eval("ADDRESS")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkView" runat="server" OnClick="lnkView_Click" CssClass="btn btn-info"
                                                    Font-Size="11px" Width="60px" ForeColor="White" Style="padding: 5px;">View</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                       
                                    </Columns>
